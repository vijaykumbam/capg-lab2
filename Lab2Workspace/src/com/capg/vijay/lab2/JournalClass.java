 ...
 *
 */
public class JournalClass extends WrittenItemClass {

	public JournalClass(int idNumber, String title, int noOfCopies, int publishedYear) {
	...
	public static void main(String[] args) {
		...
		ItemClass jcobj = new JournalClass(1234,"Autonomous research paper",1,publishedYear);
		jcobj.checkIn();
		jcobj.checkOut();
